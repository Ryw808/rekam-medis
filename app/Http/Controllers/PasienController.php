...
class PasienController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pasien.form', compact('model', 'jk', 'gd', 'latestnorm', 'pekerjaan', 'pendidikan', 'st_kawin', 'pasien_tp'));
        //dd($gender);
    }
    ...
    public function store(Request $request)
    {
        ...
        $pasien->id_gol_darah = $request->id_gol_darah;
    ...
    public function edit($id)
    {
        ...
        return view('pasien.edit_form', compact('model', 'jk', 'gd', 'pekerjaan', 'pendidikan', 'st_kawin', 'pasien_tp'));
        //dd($model);
    }
