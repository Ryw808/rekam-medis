...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_gender', $jk, null, ['class' => 'form-control select2 required', 'id'=>'id_gender',
                'placeholder'=>'Pilih Jenis Kelamin..']); !!}
            </div>
        </div>
        <div class="form-group row">
            {!! Form::label('gd', 'Golongan Darah', ['class' => 'control-label col-sm-3 col-form-label']) !!}
            <div class="col-sm-9">
                {!! Form::select('id_gol_darah', $gd, null, ['class' => 'form-control select2', 'id'=>'id_gol_dara',
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::text('tgl_lahir', date('d-m-Y', strtotime($model->tgl_lahir)), ['class' => 'form-control',
                'id'=>'tgl_lahir', 'data-inputmask' => "'alias':'dd/mm/yyyy'", 'data-mask']) !!}
            </div>
        </div>
        <div class="form-group row">
            {!! Form::label('alamat', 'Alamat', ['class' => 'control-label col-sm-3 col-form-label']) !!}
            <div class="col-sm-9">
                {!! Form::textarea('alamat', null, ['class' => 'form-control', 'id' => 'alamat', 'cols' => '5', 'rows'
                => '3']) !!}
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_status_kawin', $st_kawin, null, ['class' => 'form-control select2 required',
                'id'=>'id_status_kawin', 'placeholder'=>'Pilih Status..']); !!}
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_pekerjaan', $pekerjaan, null, ['class' => 'form-control select2 required',
                'id'=>'id_pekerjaan', 'placeholder'=>'Pilih Pekerjaan..']); !!}
            </div>
        </div>
        <div class="form-group row">
            {!! Form::label('pendidikan', 'Pendidikan', ['class' => 'control-label col-sm-3 col-form-label']) !!}
            <div class="col-sm-9">
                {!! Form::select('id_pendidikan', $pendidikan, null, ['class' => 'form-control select2 required',
                'id'=>'id_pendidikan', 'placeholder'=>'Pilih Pendidikan..']); !!}
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_pasien_tp', $pasien_tp, null, ['class' => 'form-control select2 required',
                'id'=>'id_pasien_tp', 'placeholder'=>'Pilih Tipe Pasien..']); !!}
            </div>
        </div>
