...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_gender', $jk, null, ['class' => 'form-control select2', 'id'=>'id_gender',
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_status_kawin', $st_kawin, null, ['class' => 'form-control select2',
    ...
    <div class="col-md-6">
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_pekerjaan', $pekerjaan, null, ['class' => 'form-control select2',
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_pendidikan', $pendidikan, null, ['class' => 'form-control select2',
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!! Form::select('id_pasien_tp', $pasien_tp, null, ['class' => 'form-control select2',
